...
TimeSeries1 <- read.csv(file = "Data\\TimeSeries1.csv",
                        header = TRUE, row.names = 1)
TimeSeries1_Classification <- read.csv(file = "Data\\TimeSeries1_Classification.csv",
                        header = TRUE, row.names = 1)
...
WE_TS1_Class <- read.csv(file = "Data\\TimeSeries1_WE_Classification.csv",
                         header = TRUE, row.names = 1)
