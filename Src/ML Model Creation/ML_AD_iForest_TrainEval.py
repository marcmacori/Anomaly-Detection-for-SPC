...
iforest_1_eval = RandomizedSearchCV(iforest_1, grid, cv = cv, verbose = 4, random_state=0,\
     scoring = sc, n_iter = 50, refit="AUC", n_jobs=2)
...
joblib.dump(iforest_1, 'Models\ML_iforest_1.sav')
joblib.dump(iforest_2, 'Models\ML_iforest_2.sav')
joblib.dump(iforest_3, 'Models\ML_iforest_3.sav')