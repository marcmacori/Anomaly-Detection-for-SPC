...
#Pre-processing
#Import data
TS1 = pd.read_csv("Data\TimeSeries1Poisson.csv", index_col = 0)
...
TS1_Class = pd.read_csv("Data\TimeSeries1_ClassificationPoisson.csv", index_col = 0)
...
joblib.dump(iforest, 'ML_Models\ML_iforestPoisson.sav')

joblib.dump(iforest_tuning, 'ML_Models\ML_iforest_tuningPoisson.pkl')