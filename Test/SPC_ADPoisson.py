...
#import data
TS = pd.read_csv('Data\TimeSeries1Poisson.csv', index_col = 0)
...
anomalies.to_csv("Data\TimeSeries1_Nelson_ClassificationPoisson.csv")

anomalies = AD_in_data(TS, len(TS), 20, "WE",20)
anomalies = pd.DataFrame(anomalies)
anomalies.to_csv("Data\TimeSeries1_WE_ClassificationPoisson.csv")